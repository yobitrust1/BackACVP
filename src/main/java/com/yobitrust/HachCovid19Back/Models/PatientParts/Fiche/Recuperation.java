...
public class Recuperation extends Fiche{
    ...
    public Recuperation(Integer velo, Integer charge, Integer ta, Integer tap, Integer fc, Boolean trouCon, Boolean trouRep, Boolean trouRyt) {
        this.velo = velo;
        this.charge = charge;
        this.ta = ta;
        this.tap = tap;
