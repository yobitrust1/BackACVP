...
public class Sous_decalage extends Segment {
    private  Boolean d1;
    private  Boolean d2;
    private  Boolean  d3;
    private  Boolean avr;
    ...
    private  Boolean v5;
    private  Boolean v6;
    private Sous_decalage() {
    }

    public Sous_decalage(Boolean d1, Boolean d2, Boolean d3, Boolean avr, Boolean avl, Boolean avf, Boolean v1, Boolean v2, Boolean v3, Boolean v4, Boolean v5, Boolean v6) {
        this.d1 = d1;
        this.d2 = d2;
        this.d3 = d3;
        this.avr = avr;
